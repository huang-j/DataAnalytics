#!/bin/bash
echo "Running DirectAnnotateUMISeq.py"
lanes=1
sub_dir="/media/jonathan/ASL_PC/jonathan/MS05_H2B_exoDNA-42887042/Fastq/"
...
./DirectAnnotateUMISeq.py -l $lanes -R $sub_dir$R1files0 $sub_dir$R1files1 $sub_dir$R1files2 $sub_dir$R1files3 -L $sub_dir$R2files0 $sub_dir$R1files1 $sub_dir$R1files2 $sub_dir$R1files3 -p $sub_dir